...
HD_PWD='C:/Users/ERNESTO/Documents/DANIEL/IPN/ESCOM/Quinto_Semestre/ARQUI/Memoria_de_programa/Memoria_de_programa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log program_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source program_memory.tcl
