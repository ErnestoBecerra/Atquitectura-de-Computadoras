...
HD_PWD='C:/Users/ERNESTO/Documents/DANIEL/IPN/ESCOM/Quinto_Semestre/ARQUI/elemento/elemento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log elemento.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source elemento.tcl
