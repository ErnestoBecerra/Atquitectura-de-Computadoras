...
architecture Behavioral of MemoriaPrograma2 is
    ...
    constant aux : banco := (
        LI & R1 & x"000A",                  --LI  R1, #10
        LI & R2 & x"0003",                  --LI  R2, #3
        tipoR & R3 & R3 & R1 & SU & ADD,    --et1: ADD R3, R3, R1
        ADDI & R0 & R0 & x"001",            --ADDI R0, R0, #1
        BLTI & R2 & R0 & x"3FE",            --BLTI R2, R0, et1 (001111111110 = -2)
